...
## Goal
This project has a comprehensive precommit pipeline that validates PHP, frontend, test quality, and e2e behavior.
...
- Avoid repeatedly rerunning long steps (`test:e2e`) unless touched code justifies it.
